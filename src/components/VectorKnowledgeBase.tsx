...
export const VectorKnowledgeBase: React.FC = () => {
  ...
  const categories = ["ALL", "售后政策", "账单发票", "配送物流", "账户安全", "VIP服务", "产品使用"];
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-200">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold text-slate-900">企业向量数据库与知识库管理中心</h1>
          </div>
          <p className="text-xs text-slate-500 mt-1">
            基于文本向量嵌入 (Vector Embeddings) 与余弦相似度的高性能 RAG 检索体系，支持动态语义召回与分块更新
          </p>
        </div>
